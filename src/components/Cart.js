                  ...
                  return (
                    <div className="cart_items" key={id}>
                      ...
                      <div className="cart_items_quantity">
                        <button type="button" className="btn btn-decrement" onClick={() => handleDecrement(id)}>-</button>
                        <span className="quantity">{quantity}</span>
                        <button type="button" className="btn btn-increment" onClick={() => handleIncrement(id)}>+</button>
                      </div>
